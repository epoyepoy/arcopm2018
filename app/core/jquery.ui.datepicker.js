...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = '<a class="float_left" data-handler="prev" data-event="click"><img src="images/calendar_left.svg" height="22em"/></a>';
		var nextText = this._get(inst, 'nextText');
		nextText = (!navigationAsDateFormat ? nextText : this.formatDate(nextText,
			this._daylightSavingAdjust(new Date(drawYear, drawMonth + stepMonths, 1)),
			this._getFormatConfig(inst)));
		var next = '<a class="float_right" data-handler="next" data-event="click"><img src="images/calendar_right.svg" height="22em"/></a>';
