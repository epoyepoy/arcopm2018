...
/* 
 * Angelos Choursoglou changes for Hide/Show All Images in ArcoPM Reports 11/1/2017
 */
'use strict';
...
(function (factory) {
  ...
  OrgChart.prototype = {
    ...
    showChildren: function ($node) {
	  ...
	  //Angelos Choursoglou addition 1/11/2017
		if($('#showallimages').val() === 'Hide'){
			$('.second-menu').show();
		}
    },
        ...
        if (childrenState.exist) {
          ...
          if (that.startLoading($that, $node, opts)) {
            ...
            .always(function() {
				...
				//Angelos Choursoglou addition 11/1/2017
				if($('#showallimages').val() === 'Hide'){
					$node.children('.second-menu').show();
				}
            });
          }
        }
